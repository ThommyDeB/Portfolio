...
var buttonDiv = document.getElementsByClassName('button-div');
...
function OpenCloseMenu(){
    if(!menuOpen){
        ...
        setTimeout(function(){
            ...
            menuDiv.style.zIndex = 19998;
            /*buttonDiv.forEach(element => {
                element.style.zIndex = 19998;
            });*/
            for(var i = 0;i < buttonDiv.length; i++){
                buttonDiv[i].style.zIndex = 19998;
            }
            menuCircle.className = "menu-circle circle-shrink";
            menuDiv.style.top = window.scrollY +'px';
            document.body.style.overflow = "hidden";
            setTimeout(function(){
                menuCircleParent.style.marginTop = '-400vh';
            },500);
        }, 500);
        menuOpen = true;
    }
        ...
        setTimeout(function(){
            ...
            /*for(var i = 0;i < buttonDiv.length; i++){
                buttonDiv[i].style.zIndex = -100000;
            }*/
            menuCircle.className = "menu-circle circle-shrink";
            menuDiv.style.top = window.scrollY+'px';
